...
class MultiCoinTradingController extends Controller
{
    ...
    public function execute(): JsonResponse
    {
        try {
            ...
            Log::info("🔍 AI Calculations check: " . ($useAICalculations ? "TRUE" : "FALSE"));
            Log::info("🔍 AI Calculations check: " . ($useAICalculations ? "TRUE" : "FALSE")); Log::info("🔍 AI Calculations check: " . ($useAICalculations ? "TRUE" : "FALSE")); if ($useAICalculations) {
